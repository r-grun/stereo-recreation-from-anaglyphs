# DATA
# paths for training
TRAIN_ANAGLYPH_FILE = "../../test_data/train_anaglyphs.txt" # path to the file containing the paths to the anaglyph images
...
TEST_REVERSED_FILE = "../../test_data/test_reversed.txt" # path to the file containing the paths to the reversed anaglyph images
